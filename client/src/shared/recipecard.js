    ...
    >
      ...
      <CardContent id='card-content'>
        ...
        <Typography className="recipelink">
          <a href={recipe.spoonacularSourceUrl}>Full recipe</a>
        </Typography>
        <Share recipe={recipe} />
              ...
              {recipe.usedIngredients && recipe.missedIngredients ? (
                <Typography>
                  ...
                  {recipe.usedIngredients.map((ing) => (
                    <li className="foundingredients">{ing.name}</li>
                  ))}
                  {recipe.missedIngredients.map((ing) => (
                    <li className="missingingredients">{ing.name}</li>
                  ))}
                </Typography>
              ) : null}
            </div>
            <div>
              ...
              <PieChart
                ...
                data={[
                  {
                    title: "Protein",
                    value: recipe.nutrition.caloricBreakdown.percentProtein,
                    color: "#8f4fba",
                  },
                  {
                    title: "Fat",
                    value: recipe.nutrition.caloricBreakdown.percentFat,
                    color: "#4fbaba",
                  },
                  {
                    title: "Carbs",
                    value: recipe.nutrition.caloricBreakdown.percentCarbs,
                    color: "#4fba7a",
                  },
                ]}
                viewBoxSize={[120, 120]}
