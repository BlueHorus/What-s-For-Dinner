...
class FindRecipes extends React.Component {
  ...
  renderUserDiet() {
    ...
    return (
      <ListItem
        id={this.props.user.diet}
        secondaryAction={
          <IconButton
            edge="end"
            onClick={() => this.handleRemoveDiet(this.props.user.diet)}
          >
            <DeleteIcon />
          </IconButton>
        }
      ...
      return (
        <ListItem
          ...
          secondaryAction={
            <IconButton
              edge="end"
              onClick={() => this.handleRemoveIntolerance(intolerance)}
            >
              <DeleteIcon />
            </IconButton>
          }
  ...
  handleIngredientSearch() {
    ...
    console.log(ingredients, diet, intolerances);
    let config = {
      method: "get",
      params: {
    ...
    return (
      <>
        ...
        >
                      ...
                      <ListItem
                        ...
                        secondaryAction={
                          <IconButton
                            edge="end"
                            onClick={() =>
                              this.handleRemoveIngredient(ingredient)
                            }
                          >
                            <DeleteIcon />
                          </IconButton>
                      ...
                      <ListItem
                        ...
                        secondaryAction={
                          <IconButton
                            edge="end"
                            onClick={() =>
                              this.handleRemoveIntolerance(intolerance)
                            }
                          >
                            <DeleteIcon />
                          </IconButton>
                    ...
                    return (
                      <ListItem
                        ...
                        secondaryAction={
                          <IconButton
                            edge="end"
                            onClick={() => this.handleRemoveDiet(diet)}
                          >
                            <DeleteIcon />
                          </IconButton>
                        }
          ...
          >
            <FormControl
              sx={{ m: 1, width: "33%", display: "flex", alignItems: "center" }}
              variant="standard"
            >
            ...
            >
              ...
              <TextField
                style={{ width: "100%", backgroundColor: "white" }}
                select
                onChange={this.intoleranceChange}
                id="intolerances-form"
                label="Intolerances"
                varient="filled"
                value={this.state.intoleranceFormValue}
              >
                <MenuItem key="Sesame" value="Sesame">
                  Sesame
                </MenuItem>
                <MenuItem key="Seafood" value="Seafood">
                  Seafood
                </MenuItem>
                <MenuItem key="Peanut" value="Peanut">
                  Peanut
                </MenuItem>
                <MenuItem key="Grain" value="Grain">
                  Grain
                </MenuItem>
                <MenuItem key="Gluten" value="Gluten">
                  Gluten
                </MenuItem>
                <MenuItem key="Egg" value="Egg">
                  Egg
                </MenuItem>
                <MenuItem key="TreeNut" value="TreeNut">
                  TreeNut
                </MenuItem>
                <MenuItem key="Sulfite" value="Sulfite">
                  Sulfite
                </MenuItem>
                <MenuItem key="Soy" value="Soy">
                  Soy
                </MenuItem>
                <MenuItem key="Shellfish" value="Shellfish">
                  Shellfish
                </MenuItem>
              </TextField>
              <Button
                type="submit"
                id="signup"
                onClick={this.handleIntoleranceSubmit}
                varient="filled"
                style={{
                  margin: "10px",
                  backgroundColor: "#39d3bd",
            ...
            >
              ...
              <TextField
                select
                style={{ width: "100%", backgroundColor: "white" }}
                onChange={this.dietChange}
                id="diets-form"
                label="Diets"
                varient="filled"
                value={this.state.dietsFormValue}
              >
                <MenuItem key="Gluten Free" value="Gluten Free">
                  Gluten Free
                </MenuItem>
                <MenuItem key="Ketogenic" value="Ketogenic">
                  Ketogenic
                </MenuItem>
                <MenuItem key="Vegetarian" value="Vegetarian">
                  Vegetarian
                </MenuItem>
                <MenuItem key="Lacto-Vegetarian" value="Lacto-Vegetarian">
                  Lacto-Vegetarian
                </MenuItem>
                <MenuItem key="Ovo-Vegetarian" value="Ovo-Vegetarian">
                  Ovo-Vegetarian
                </MenuItem>
                <MenuItem key="Vegan" value="Vegan">
                  Vegan
                </MenuItem>
                <MenuItem key="Pescetarian" value="Pescetarian">
                  Pescetarian
                </MenuItem>
                <MenuItem key="Paleo" value="Paleo">
                  Paleo
                </MenuItem>
                <MenuItem key="Primal" value="Primal">
                  Primal
                </MenuItem>
        ...
        <Button
          onClick={this.handleIngredientSearch}
          startIcon={
            <SearchIcon
              style={{
                fontSize: "2em",
        ...
        >
          {this.state.recipes === null ? (
            <Search style={{ maxWidth: "500px", height: "auto" }} />
          ) : (
